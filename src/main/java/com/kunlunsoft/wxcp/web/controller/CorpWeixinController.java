...
import com.kunlunsoft.wxcp.mapper.WxCpCommandToSuiteMapper;
...
//    private RightWxCpOAuth2ServiceImpl rightWxCpOAuth2Service;
    ...
    @Autowired
    private WxCpCommandToSuiteMapper wxCpCommandToSuiteMapper;
    ...
    public String jsonCommandCallback2(Model model, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (contentType.contains("xml")) {
                ...
                wxCpCommandToSuiteMapper.insert(wxCpCommandToSuite);
            }
